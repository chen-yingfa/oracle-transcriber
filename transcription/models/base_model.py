...
class BaseModel(ABC):
    ...
    def __init__(self, opt):
        ...
        Then, you need to define four lists:
            -- self.loss_names (str list):          specify the training losses
                that you want to plot and save.
            ...
            -- self.optimizers (optimizer list):    define and initialize
                ...
                If two networks are updated at the same time, you can use
                itertools.chain to group them. See cycle_gan_model.py for an example.
        """
        self.opt = opt
    ...
    def update_learning_rate(self):
        ...
        print("learning rate %.7f -> %.7f" % (old_lr, lr), flush=True)
    ...
    def load_networks(self, epoch):
        ...
        for name in self.model_names:
            ...
            load_path = Path(self.save_dir, load_filename)
            net = getattr(self, "net" + name)
